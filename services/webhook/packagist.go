...
func (pc packagistConvertor) User(_ *api.UserPayload) (PackagistPayload, error) {
	return PackagistPayload{}, nil
}

func (pc packagistConvertor) Organization(_ *api.OrganizationPayload) (PackagistPayload, error) {
	return PackagistPayload{}, nil
}
